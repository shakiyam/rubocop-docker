...
all: check_for_image_updates hadolint shellcheck shfmt update_lockfile build ## Lint, update Gemfile.lock, and build
	@:

build: ## Build an image from a Dockerfile
	@echo -e "\033[36m$@\033[0m"
	@./tools/build.sh docker.io/shakiyam/rubocop
